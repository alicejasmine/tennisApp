...
@Component({
  template: `
      <ion-content>
          ...
          <ion-button data-testid="submit" [disabled]="editMatchForm.invalid" (click)="editMatch()">Update</ion-button>
      </ion-content>
  `,
...
export class EditEndingMatchComponent {
  ...
  constructor(public fb: FormBuilder, public modalController: ModalController, public http: HttpClient, public dataService: DataService, public toastController: ToastController,  public router: Router,) {
